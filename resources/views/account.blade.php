    ...
    <div class="container-fluid">
        <div class="container">
            <ul class="nav nav-pills center-pills">
                <li class="nav-item">
                    <a href="{{url('/account/Music')}}" class="nav-link pill-head show active" data-bs-toggle="pill">Collected</a>
                </li>
                <li class="nav-item">
                    <a href="{{url('/account/Art')}}" class="nav-link pill-head" data-bs-toggle="pill">Created</a>
                </li>
                <li class="nav-item">
